...
class Frontend {
   public:
    ...
    void SetLoopClosure(std::shared_ptr<LoopClosure> loop_closure) { loop_closure_ = loop_closure; }
   ...
   private:
    ...
    int num_features_needed_for_keyframe_ = 300;

    // utilities
//    cv::Ptr<cv::GFTTDetector> gftt_;  // feature detector in opencv
    cv::Ptr<cv::Feature2D> orb_detector_ = cv::ORB::create();
};
